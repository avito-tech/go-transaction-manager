...
func (r *readonlyFuncWithoutTxDecorator) GetRange(
	ctx context.Context,
	key string,
	start, end int64,
) *redis.StringCmd {
...
func (r *readonlyFuncWithoutTxDecorator) GetBit(
	ctx context.Context,
	key string,
	offset int64,
) *redis.IntCmd {
...
func (r *readonlyFuncWithoutTxDecorator) BitCount(
	ctx context.Context,
	key string,
...
func (r *readonlyFuncWithoutTxDecorator) BitPos(
	ctx context.Context,
	key string,
	bit int64,
	pos ...int64,
...
func (r *readonlyFuncWithoutTxDecorator) Scan(
	ctx context.Context,
	cursor uint64,
	match string,
	count int64,
...
func (r *readonlyFuncWithoutTxDecorator) SScan(
	ctx context.Context,
	key string,
	cursor uint64,
	match string,
...
func (r *readonlyFuncWithoutTxDecorator) HScan(
	ctx context.Context,
	key string,
	cursor uint64,
	match string,
...
func (r *readonlyFuncWithoutTxDecorator) ZScan(
	ctx context.Context,
	key string,
	cursor uint64,
	match string,
...
func (r *readonlyFuncWithoutTxDecorator) HExists(
	ctx context.Context,
	key, field string,
) *redis.BoolCmd {
...
func (r *readonlyFuncWithoutTxDecorator) HGet(
	ctx context.Context,
	key, field string,
) *redis.StringCmd {
...
func (r *readonlyFuncWithoutTxDecorator) HGetAll(
	ctx context.Context,
	key string,
...
func (r *readonlyFuncWithoutTxDecorator) HKeys(
	ctx context.Context,
	key string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) HMGet(
	ctx context.Context,
	key string,
	fields ...string,
) *redis.SliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) HVals(
	ctx context.Context,
	key string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) HRandField(
	ctx context.Context,
	key string,
	count int,
	withValues bool,
...
func (r *readonlyFuncWithoutTxDecorator) LIndex(
	ctx context.Context,
	key string,
	index int64,
) *redis.StringCmd {
...
func (r *readonlyFuncWithoutTxDecorator) LPos(
	ctx context.Context,
	key string,
	value string,
	args redis.LPosArgs,
...
func (r *readonlyFuncWithoutTxDecorator) LRange(
	ctx context.Context,
	key string,
	start, stop int64,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SDiff(
	ctx context.Context,
	keys ...string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SInter(
	ctx context.Context,
	keys ...string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SIsMember(
	ctx context.Context,
	key string,
	member interface{},
) *redis.BoolCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SMIsMember(
	ctx context.Context,
	key string,
	members ...interface{},
) *redis.BoolSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SMembers(
	ctx context.Context,
	key string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SRandMember(
	ctx context.Context,
	key string,
) *redis.StringCmd {
...
func (r *readonlyFuncWithoutTxDecorator) SUnion(
	ctx context.Context,
	keys ...string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) XRange(
	ctx context.Context,
	stream, start, stop string,
) *redis.XMessageSliceCmd {
	return r.readOnly.XRange(ctx, stream, start, stop)
}

func (r *readonlyFuncWithoutTxDecorator) XRevRange(
	ctx context.Context,
	stream string,
	start, stop string,
) *redis.XMessageSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) XRead(
	ctx context.Context,
	a *redis.XReadArgs,
...
func (r *readonlyFuncWithoutTxDecorator) XPending(
	ctx context.Context,
	stream, group string,
) *redis.XPendingCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZCount(
	ctx context.Context,
	key, minValue, maxValue string,
) *redis.IntCmd {
	return r.readOnly.ZCount(ctx, key, minValue, maxValue)
}

func (r *readonlyFuncWithoutTxDecorator) ZLexCount(
	ctx context.Context,
	key, minValue, maxValue string,
) *redis.IntCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZInter(
	ctx context.Context,
	store *redis.ZStore,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZMScore(
	ctx context.Context,
	key string,
	members ...string,
) *redis.FloatSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRange(
	ctx context.Context,
	key string,
	start, stop int64,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRangeByScore(
	ctx context.Context,
	key string,
	opt *redis.ZRangeBy,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRangeByLex(
	ctx context.Context,
	key string,
	opt *redis.ZRangeBy,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRank(
	ctx context.Context,
	key, member string,
) *redis.IntCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRevRange(
	ctx context.Context,
	key string,
	start, stop int64,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRevRangeByScore(
	ctx context.Context,
	key string,
	opt *redis.ZRangeBy,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRevRangeByLex(
	ctx context.Context,
	key string,
	opt *redis.ZRangeBy,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRevRank(
	ctx context.Context,
	key, member string,
) *redis.IntCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZScore(
	ctx context.Context,
	key, member string,
) *redis.FloatCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZUnion(
	ctx context.Context,
	store redis.ZStore,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) ZRandMember(
	ctx context.Context,
	key string,
	count int,
	withScores bool,
...
func (r *readonlyFuncWithoutTxDecorator) ZDiff(
	ctx context.Context,
	keys ...string,
) *redis.StringSliceCmd {
...
func (r *readonlyFuncWithoutTxDecorator) PFCount(
	ctx context.Context,
	keys ...string,
) *redis.IntCmd {
...
func (r *readonlyFuncWithoutTxDecorator) GeoPos(
	ctx context.Context,
	key string,
	members ...string,
) *redis.GeoPosCmd {
...
func (r *readonlyFuncWithoutTxDecorator) GeoSearch(
	ctx context.Context,
	key string,
...
func (r *readonlyFuncWithoutTxDecorator) GeoDist(
	ctx context.Context,
	key string,
	member1, member2, unit string,
) *redis.FloatCmd {
	return r.readOnly.GeoDist(ctx, key, member1, member2, unit)
}

func (r *readonlyFuncWithoutTxDecorator) GeoHash(
	ctx context.Context,
	key string,
	members ...string,
) *redis.StringSliceCmd {
