...
// DefaultXSettings returns XSettings that wraps base with experimental defaults (EnableSavepointHooks=false, InitialHooks=nil).
func DefaultXSettings(base Settings) XSettings {
	return &xSettingsWrap{Settings: base}
}
